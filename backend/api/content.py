...
def get_article(
    ...
    return ArticleResponse(
        ...
        featured_image=result["article"].featured_image,
...
def create_category(
    ...
    return CategoryResponse(
        ...
        slug=category.slug,
        parent_id=None,  # parent_id не поддерживается в модели
        is_active=category.is_active,
        created_at=category.created_at,
        updated_at=category.created_at,  # updated_at не поддерживается в модели
        articles_count=0,
